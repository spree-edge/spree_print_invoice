pdf.repeat(:all) do
  pdf.grid([7,0], [7,4]).bounding_box do
    ...
    data << [pdf.make_cell(content: Spree::PrintInvoice::Config[:preferred_footer_left],  align: :left),
    pdf.make_cell(content: Spree::PrintInvoice::Config[:preferred_footer_right], align: :right)]
